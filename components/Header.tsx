...
function Header() {
  ...
  return (
    <header className="flex flex-col md:flex-row bg-walmart items-center px-10 py-7 space-x-5">
        ...
        <form onSubmit={handleSubmit} className="flex items-center bg-white rounded-full flex-1 w-full ">
            <input
            name="input" 
            type="text" 
            ...
            <button type="submit">
                <Search className="rounded-full h-10 px-2 w-10 cursor-pointer bg-yellow-400"/>
            </button>
        </form>
